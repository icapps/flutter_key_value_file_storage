...
// in flutter_key_value_file_storage/example/ios/.symlinks/plugins/flutter_key_value_file_storage/test/flutter_key_value_file_storage_test.dart.
...
class MockFileStorage extends _i1.Mock implements _i5.FileStorage {
  ...
  @override
  _i4.Future<_i6.Uint8List?> read(String? filename) => (super.noSuchMethod(
        Invocation.method(
          #read,
          [filename],
        ),
  ...
  @override
  _i4.Future<bool> exists(String? filename) => (super.noSuchMethod(
        Invocation.method(
          #exists,
          [filename],
        ),
  ...
  @override
  _i4.Future<void> delete(String? filename) => (super.noSuchMethod(
        Invocation.method(
          #delete,
          [filename],
        ),
